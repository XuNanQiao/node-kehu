...
var handleSlimScroll = function () {
    ...
    handleLoadPage = function (a) {
        Pace.restart();
        var b = a.replace("#", "");
        $(".jvectormap-label, .jvector-label, .AutoFill_border ,#gritter-notice-wrapper, .ui-autocomplete, .colorpicker, .FixedHeader_Header, .FixedHeader_Cloned .lightboxOverlay, .lightbox").remove(), $.ajax({
            type: "GET",
            url: b,
            dataType: "html",
            success: function (a) {
                $("#ajax-content").html(a), $("html, body").animate({scrollTop: $("body").offset().top}, 250)
            },
            error: function (a, b, c) {
                $("#ajax-content").html(default_content)
            }
        })
    }, handleCheckPageLoadUrl = function (a) {
        a = a ? a : "#ajax/index_v2.html", "" === a ? $("#ajax-content").html(default_content) : ($('.sidebar [href="' + a + '"][data-toggle=ajax]').trigger("click"), handleLoadPage(a))
    }, handleSidebarAjaxClick = function () {
        $(".sidebar [data-toggle=ajax]").click(function () {
            var a = $(this).closest("li"), b = $(this).parents();
            $(".sidebar li").not(a).not(b).removeClass("active"), $(a).addClass("active"), $(b).addClass("active")
        })
    }, handleHashChange = function () {
        $(window).hashchange(function () {
            window.location.hash && handleLoadPage(window.location.hash)
        })
        ...
        $('[data-click="next-tab"]').live("click", function (a) {
            a.preventDefault(), b(this, "next")
        }), $('[data-click="prev-tab"]').live("click", function (a) {
        ...
        $('[data-click="next-menu"]').live("click", function (b) {
            b.preventDefault(), a(this, "next")
        }), $('[data-click="prev-menu"]').live("click", function (b) {
        ...
        return {
            init: function () {
                this.initLocalStorage(), this.initSidebar(), this.initTopMenu(), this.initPageLoad(), this.initComponent(), this.initThemePanel(), this.initAjaxFunction()
                ...
                handleSidebarAjaxClick(), handleCheckPageLoadUrl(window.location.hash), handleHashChange(), $.ajaxSetup({cache: !0})
